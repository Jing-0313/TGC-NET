...
def plot_prediction_results(y_true, y_pred, save_path="/home/ys/new/TGC-Net/data/result/ph/test_prediction.png"):
    ...
    plt.title(f'Final Independent Test\nR2: {r2:.3f} | MAE: {mae:.2f} | RMSE: {rmse:.2f}')
    plt.xlabel('Experimental pHopt')
    plt.ylabel('Predicted pHopt')
    plt.legend()
    plt.tight_layout()
...
def run_training():
    ...
    parser.add_argument('--train_path', type=str, default='/home/ys/new/TGC-Net/data/ph/train-ph.csv')
    parser.add_argument('--test_path', type=str, default='/home/ys/new/TGC-Net/data/ph/test-ph.csv')
    parser.add_argument('--structure_path', type=str, default='/home/ys/new/TGC-Net/data/ph/ph-structures.pt',
                        help='训练集和验证集结构坐标 .pt 文件')
    parser.add_argument('--test_structure_path', type=str, default='/home/ys/new/TGC-Net/data/ph/ph-structures.pt',
                        help='独立测试集结构坐标 .pt 文件')
    parser.add_argument('--quality_path', type=str, default='/home/ys/new/TGC-Net/data/ph/ph-quality.csv')
    parser.add_argument('--plddt_threshold', type=float, default=0.7)
    parser.add_argument('--task', type=str, default='pHopt')
    parser.add_argument('--target_min', type=float, default=0.0, help='pHopt归一化下界')
    parser.add_argument('--target_max', type=float, default=14.0, help='pHopt归一化上界')
    ...
    parser.add_argument('--save_path', type=str, default='/home/ys/new/TGC-Net/data/result/ph/ph_best_model.pth')
    parser.add_argument('--ckpt_path', type=str, default='/home/ys/new/TGC-Net/data/result/ph/checkpoint.pth')
    parser.add_argument('--final_pred_path', type=str, default='/home/ys/new/TGC-Net/data/result/ph/results-ph.csv')
    parser.add_argument('--history_fig_path', type=str, default='/home/ys/new/TGC-Net/data/result/ph/training.png')
    parser.add_argument('--final_fig_path', type=str, default='/home/ys/new/TGC-Net/data/result/ph/test_prediction.png')
    ...
    print("=" * 60 + "\n")
    out_df = df_te.copy()
    out_df['true_pHopt'] = y_true
    out_df['pred_pHopt'] = y_pred
