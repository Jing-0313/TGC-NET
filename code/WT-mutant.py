...
def main():
    ...
    parser.add_argument('--input', default='/home/ys/new/xvjing/casestudy2/Tubian-case.csv')
    parser.add_argument('--output', default='/home/ys/new/xvjing/casestudy2/0.614result.csv')
    parser.add_argument('--model_path', default='/home/ys/new/xvjing/path/topt5/6topt_best_model_0.614.pth')
    parser.add_argument('--structure_path', default='/home/ys/new/xvjing/casestudy2/structures.pt')
