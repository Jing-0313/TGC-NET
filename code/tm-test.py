...
class MultimodalTmPredictor:
    ...
    def predict(self, df, batch_size=1):
        ...
        df['pred_tm'] = all_preds
        return df

    def paper_style_benchmark_visualization(self, df, save_path, task_col='tm'):
        if task_col not in df.columns:
            return
        y_true = df[task_col].values
        y_pred = df['pred_tm'].values
        ...
        plt.xlabel('Experimental $T_m$ (°C)', fontsize=12, fontweight='bold')
        plt.ylabel('Predicted $T_m$ (°C)', fontsize=12, fontweight='bold')
...
def main():
    ...
    parser.add_argument('--input', default='/home/ys/new/TGC-Net/data/tm/test-tm.csv')
    parser.add_argument('--output', default='/home/ys/new/TGC-Net/data/result/tm/result1.csv')
    parser.add_argument('--model_path', default='/home/ys/new/TGC-Net/data/result/tm/tm_best_model.pth')
    parser.add_argument('--structure_path', default='/home/ys/new/TGC-Net/data/tm/tm-structures.pt')
    parser.add_argument('--quality_path', default='/home/ys/new/TGC-Net/data/tm/quality_report.csv')
    parser.add_argument('--esm_name', default='facebook/esm2_t33_650M_UR50D')
    parser.add_argument('--batch_size', type=int, default=4)
    args = parser.parse_args()

    predictor = MultimodalTmPredictor(args.model_path, args.esm_name, args.structure_path)
